...
class NewsDataInner(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """NewsDataInner - a model defined in OpenAPI
